...
name= input("Welcome to Rule Based Chatbot, enter your name : ")  
...
responses = {  
    ...
    "I am feeling happy": "Great to hear that",
    "functions kya hote hai": "Functions are predefined block of code which is reusable"
} 
